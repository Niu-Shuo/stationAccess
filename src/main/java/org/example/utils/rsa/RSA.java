 ...
 * @Description : RSA非对称加密加密工具类，包括加密和解密，密钥应该由KAC分发
 */
public class RSA {
    //签名算法名称
    ...
    public void encryptAndDecrypt() throws Exception {
        ...
        String encrypt = RSA.encryptByPublicKey(data, publicKeyStr);
        System.out.println("加密后数据：" + encrypt);
        // 私钥解密
        String decrypt = RSA.decryptByPrivateKey(encrypt, privateKeyStr);
